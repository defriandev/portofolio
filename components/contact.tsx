...
const links = [
  {
    label: "Email",
    href: "mailto:defrian.bagus.dewanta.410810-2023@vokasi.unair.ac.id",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/defrian-bagus-138476354",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/defriandev",
    icon: (
  ...
  {
    label: "WhatsApp",
    href: "https://wa.me/62859183875494",
    icon: (
      ...
      <div className="container">
        ...
        >
          ...
          <p className="contact-text">
            ...
            to reach out if you think I&apos;d be a good fit for your team!
          </p>
